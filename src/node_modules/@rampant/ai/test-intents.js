...
const success = msg => {
    testCount += 1
    return `    ${white(`#${testCount}`.padEnd(3, ' '))} ${green('✔')} ${grey(
        msg
    )}`
}
...
export const project = {
    intents: [
        ...
        },
        {
            ...
            sources: [
                { name: 'basicTemplateTest', intent: 'basicTemplateTest' },
            ],
            defaults: {
                greeting: 'Hello',
                subject: 'World',
        ...
        },
        {
            ...
            sources: [
                { name: 'twitterRetweetTest', intent: 'twitterRetweetTest' },
            ],
            defaults: {
                userId: 'raybenefield',
